...
beforeAll(async () => {
  ...
  // Fix: asegurar que exercise_sessions acepta los 9 widget kinds.
  // La migration 013 ya lo aplica, pero este guard es idempotente y
  // protege contra DBs donde 013 se registró pero no corrió completo.
  await pool.query(`
    DO $$
    DECLARE rec RECORD;
    BEGIN
